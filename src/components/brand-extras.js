...
export default function BrandExtras({ website, b2b, lookbook }) {
  return (
    console.log(lookbook) || (
      <ul className={brandExtrasUl}>
        {lookbook && (
          <li className={brandExtrasLi}>
            <a className={brandExtrasAnchor} href={lookbook.url}>
              <svg
                className={brandExtrasSVG}
                viewBox="0 0 576 512"
        ...
        {website && (
          <li className={brandExtrasLi}>
            <a className={brandExtrasAnchor} href={website}>
              <svg
                className={brandExtrasSVG}
                viewBox="0 0 576 512"
                xmlns="http://www.w3.org/2000/svg"
        ...
        {b2b && (
          <li className={brandExtrasLi}>
            <a className={brandExtrasAnchor} href={b2b}>
              <svg
                className={brandExtrasSVG}
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
